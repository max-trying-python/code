...
# list of students
students = ["Fred", "Sally", "Bruno", "Donny", "Monica", "Esme"]
# class total (1 - 4)
total = 0


for student in students:
    inputText = input("Hey {}, what's your grade?\n> ".format(student))
    grade = getGrade(inputText)
    if not grade == "Invalid grade.":
        total += float(inputText)
